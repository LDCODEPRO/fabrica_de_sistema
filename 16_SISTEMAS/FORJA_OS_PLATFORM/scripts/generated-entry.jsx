...
(function () {
  ...
  const modulos = [
    ...
    { id: 'inteligencia', nome: 'Inteligência',     icon: 'compass',  grupo: 'Operação',     status: 'IMPL',   desc: 'Inteligência de mercado e pesquisa estratégica' },
    ...
    { id: 'conhecimento', nome: 'Conhecimento',     icon: 'book',     grupo: 'Recursos',     status: 'IMPL',   desc: 'Rules, Workflows, Skills, Templates, Memória' },
  ...
  const equipes = [
    ...
    { id: 'ceo',          nome: 'CEO',                    icon: 'building', status: 'IMPL',   sobre: 'Define direção estratégica, metas e decisões de alto nível da Fábrica.', responsabilidades: ['Definir metas','Aprovar projetos','Decisões estratégicas'], ferramentas: ['Roadmap','Financeiro'], skills: ['Estratégia','Decisão'], workflows: ['Revisão executiva'] },
    { id: 'estrategia',   nome: 'Estratégia',             icon: 'compass',  status: 'IMPL',   sobre: 'Planejamento estratégico, posicionamento e roadmap de produto.', responsabilidades: ['Planejamento','Posicionamento','Análise SWOT'], ferramentas: ['Inteligência','Roadmap'], skills: ['Planejamento'], workflows: ['Plano estratégico'] },
    { id: 'inteligencia', nome: 'Inteligência de Mercado',icon: 'compass',  status: 'IMPL',   sobre: 'Pesquisa de mercado, concorrentes, tendências e benchmark.', responsabilidades: ['Monitorar concorrentes','Detectar tendências','Benchmark','SEO'], ferramentas: ['Navegador','Inteligência'], skills: ['Pesquisa','Benchmark'], workflows: ['Varredura de mercado'] },
    { id: 'designer',     nome: 'Designer',               icon: 'eye',      status: 'IMPL',  sobre: 'Identidade visual, UI/UX, protótipos e design de produto.', responsabilidades: ['UI/UX','Identidade visual','Protótipos','Design system'], ferramentas: ['Figma','Penpot','Canva','Photopea'], skills: ['UI','UX','Branding'], workflows: ['Exploração de design','Handoff'] },
    { id: 'desenvolvimento',nome: 'Desenvolvimento',      icon: 'cpu',      status: 'IMPL',  sobre: 'Geração e entrega de código, arquitetura e implementação.', responsabilidades: ['Codificar','Arquitetura','Code review','Refatoração'], ferramentas: ['VS Code','GitHub'], skills: ['Frontend','Backend','DevOps'], workflows: ['Scaffold','PR & review'] },
    { id: 'redes',        nome: 'Redes Sociais',          icon: 'megaphone',status: 'IMPL',   sobre: 'Conteúdo, calendário e gestão de presença em redes sociais.', responsabilidades: ['Calendário','Conteúdo','Engajamento'], ferramentas: ['Canva','Google Calendar'], skills: ['Copywriting','Mídia'], workflows: ['Publicação'] },
    { id: 'ia',           nome: 'IA',                     icon: 'zap',      status: 'IMPL',  sobre: 'Modelos, prompts, RAG e orquestração cognitiva.', responsabilidades: ['Gerir LLMs','Prompts','RAG','Avaliação'], ferramentas: ['LLM Router','Conhecimento'], skills: ['Prompt eng.','RAG'], workflows: ['Avaliação de modelo'] },
    { id: 'dados',        nome: 'Dados',                  icon: 'db',       status: 'IMPL',   sobre: 'Engenharia de dados, ETL, indexação e analytics.', responsabilidades: ['ETL','Indexação','Analytics'], ferramentas: ['Banco','Operações'], skills: ['SQL','Pipelines'], workflows: ['Pipeline ETL'] },
    { id: 'qualidade',    nome: 'Qualidade',              icon: 'check',    status: 'IMPL',   sobre: 'Testes, cobertura, gates de qualidade e validação.', responsabilidades: ['Testes','Cobertura','Gates'], ferramentas: ['Testes','Validação'], skills: ['QA','E2E'], workflows: ['Suíte de testes'] },
    { id: 'seguranca',    nome: 'Segurança',              icon: 'shield',   status: 'IMPL',   sobre: 'Hardening, CVEs, SSO, cofre de segredos e conformidade.', responsabilidades: ['Hardening','CVE scan','Cofre','SSO'], ferramentas: ['Auditoria','Cofre'], skills: ['AppSec','Compliance'], workflows: ['Scan de segurança'] },
    { id: 'documentacao', nome: 'Documentação',           icon: 'book',     status: 'IMPL',   sobre: 'Documentação técnica, ADRs e handoff de conhecimento.', responsabilidades: ['Docs','ADRs','Handoff'], ferramentas: ['Obsidian','Conhecimento'], skills: ['Redação técnica'], workflows: ['Geração de docs'] },
    { id: 'operacoes',    nome: 'Operações',              icon: 'server',   status: 'IMPL',  sobre: 'Infraestrutura, deploy, monitoramento e backups.', responsabilidades: ['Infra','Deploy','Monitoramento','Backups'], ferramentas: ['Operações','GitHub'], skills: ['SRE','DevOps'], workflows: ['Deploy','Health check'] },
    { id: 'financeiro',   nome: 'Financeiro',             icon: 'dollar',   status: 'IMPL',   sobre: 'Custos, assinaturas, billing e controle financeiro.', responsabilidades: ['Custos','Billing','Limites'], ferramentas: ['Financeiro'], skills: ['FinOps'], workflows: ['Fechamento mensal'] },
    { id: 'atendimento',  nome: 'Atendimento / Suporte',  icon: 'help',     status: 'IMPL',   sobre: 'Suporte ao operador, chamados e orientação de uso.', responsabilidades: ['Chamados','FAQ','Orientação'], ferramentas: ['Ajuda'], skills: ['Suporte'], workflows: ['Atendimento de chamado'] },
  ];
