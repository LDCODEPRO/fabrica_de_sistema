...
# 1. Abra o arquivo de prompt em: PROMPTS/DOCS_AGENT_PROMPT.md
# 2. Copie o conteudo para ChatGPT, Claude ou outro LLM.
# 3. APAGUE este bloco de instrucoes e cole a resposta aqui.
# 4. Salve o arquivo.
# 5. Execute: agent_runtime.ps1 -ProjectName "PROJETO_002_TESTE_SAAS" -AgentName "DOCS_AGENT" -Mode Ingest
